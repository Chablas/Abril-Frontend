...
/**
 * Navegador de carpetas de OneDrive/SharePoint para la carpeta de facturas.
 * El usuario pega el link, pulsa "Detectar", y navega las subcarpetas hasta
 * la carpeta deseada. Emite la carpeta seleccionada.
 */
@Component({
  selector: 'app-invoice-folder-picker',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './folder-picker.html',
})
export class InvoiceFolderPicker implements OnInit {
  @Input() linkUrl = '';
