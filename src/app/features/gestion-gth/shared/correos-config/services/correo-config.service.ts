 ...
 *
 * Todas las operaciones reciben el `modulo` porque hay cuatro pantallas con su propio juego de
 * correos —Solicitud de Personal, Aprobaciones, Reclutamiento y Onboarding— y el backend acota
 * cada una a los suyos.
 */
