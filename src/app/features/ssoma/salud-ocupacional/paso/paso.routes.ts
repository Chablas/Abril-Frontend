...
export const PASO_ROUTES: Routes = [
  { path: '', redirectTo: 'dashboard', pathMatch: 'full' },
  {
    ...
    data: { titulo: 'PASO - DASHBOARD', featureKey: 'ssoma.paso.dashboard' },
  },
  {
    path: 'lista',
    component: PasoListaComponent,
    canActivate: [roleGuard],
    data: { titulo: 'PASO - PROGRAMAS', featureKey: 'ssoma.paso.lista' },
  },
  {
    path: 'alertas',
    component: PasoAlertasComponent,
    canActivate: [roleGuard],
    data: { titulo: 'PASO - ALERTAS', featureKey: 'ssoma.paso.alertas' },
  },
  {
    path: 'actividad/:id',
    component: PasoActividadDetalleComponent,
    canActivate: [roleGuard],
    data: { titulo: 'PASO - ACTIVIDAD', featureKey: 'ssoma.paso.lista' },
  },
  {
    path: ':id',
    component: PasoDetalleComponent,
    canActivate: [roleGuard],
    data: { titulo: 'PASO - DETALLE', featureKey: 'ssoma.paso.lista' },
  },
];
