...
export const PASO_ROUTES: Routes = [
  { path: '', redirectTo: 'dashboard', pathMatch: 'full' },
  {
    ...
    data: { titulo: 'PASO - DASHBOARD', featureKey: 'ssoma.gestion.paso' },
  },
  {
    path: 'lista',
    component: PasoListaComponent,
    canActivate: [roleGuard],
    data: { titulo: 'PASO - PROGRAMAS', featureKey: 'ssoma.gestion.paso' },
  },
  {
    path: 'alertas',
    component: PasoAlertasComponent,
    canActivate: [roleGuard],
    data: { titulo: 'PASO - ALERTAS', featureKey: 'ssoma.gestion.paso' },
  },
  {
    path: 'actividad/:id',
    component: PasoActividadDetalleComponent,
    canActivate: [roleGuard],
    data: { titulo: 'PASO - ACTIVIDAD', featureKey: 'ssoma.gestion.paso' },
  },
  {
    path: ':id',
    component: PasoDetalleComponent,
    canActivate: [roleGuard],
    data: { titulo: 'PASO - DETALLE', featureKey: 'ssoma.gestion.paso' },
  },
];
