...
export const GESTION_ADMINISTRATIVA_TABS: AbrilPageTab[] = [
  ...
  { label: 'Configuración',          icono: 'ti-settings',   route: '/gestion-administrativa/configuracion',       featureKeys: ['gestion-administrativa.config.lugares','gestion-administrativa.config.motivos','gestion-administrativa.config.trayectos','gestion-administrativa.config.revisor-salidas','gestion-administrativa.config.revisores-areas','gestion-administrativa.config.visibilidad-salidas','gestion-administrativa.config.carpeta-adjuntos','gestion-administrativa.config.correos'] },
];
