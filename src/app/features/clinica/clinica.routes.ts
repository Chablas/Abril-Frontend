...
export const CLINICA_ROUTES: Routes = [
  { path: '', redirectTo: 'dashboard', pathMatch: 'full' },
  {
    ...
    data: { titulo: 'CLÍNICA', featureKey: 'clinica.agenda', roles: ['CLINICA'] },
  },
  {
    path: 'agenda',
    loadComponent: () => import('./pages/agenda/agenda').then(m => m.Agenda),
    canActivate: [authGuard, roleGuard],
    data: { titulo: 'CLÍNICA - AGENDA DEL DÍA', featureKey: 'clinica.agenda', roles: ['CLINICA'] },
  },
  {
    path: 'programaciones',
    loadComponent: () =>
    ...
    canActivate: [authGuard, roleGuard],
    data: { titulo: 'CLÍNICA - PROGRAMACIONES', featureKey: 'clinica.programaciones', roles: ['CLINICA'] },
  },
  {
    path: 'interconsultas',
    loadComponent: () =>
    ...
    canActivate: [authGuard, roleGuard],
    data: { titulo: 'CLÍNICA - INTERCONSULTAS', featureKey: 'clinica.agenda', roles: ['CLINICA'] },
  },
  {
    path: 'emos',
    loadComponent: () => import('./pages/emos/emos').then(m => m.ClinicaEmos),
    canActivate: [authGuard, roleGuard],
    data: { titulo: 'CLÍNICA - CONTROL DE EMOs', featureKey: 'clinica.agenda', roles: ['CLINICA'] },
  },
];
